#
# Sphinx configuration for aiida-gromacs
#
...
release = aiida_gromacs.__version__
...
# of the sidebar.
html_logo = "images/gromacs-BioSimDB-logo.png"
...
html_use_opensearch = "http://aiida-gromacs.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_gromacs")
