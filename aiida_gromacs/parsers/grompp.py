...
class GromppParser(Parser):
    ...
    def __init__(self, node):
        ...
        """
        super().__init__(node)
        if not issubclass(node.process_class, GromppCalculation):
            raise exceptions.ParsingError("Can only parse GromppCalculation")
    ...
    def parse(self, **kwargs):
        ...
        outputs = ["stdout"]
        output_template = {"o": "tprfile", "po": "po_file", "pp": "pp_file", "imd": "imd_file"}
